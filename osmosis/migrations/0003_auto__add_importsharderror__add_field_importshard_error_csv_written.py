...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'osmosis_importsharderror', (
            ...
            ('shard', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['osmosis.ImportShard'])),
            ('line', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'osmosis', ['ImportShardError'])

        # Adding field 'ImportShard.error_csv_written'
        db.add_column(u'osmosis_importshard', 'error_csv_written',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ImportShardError'
        db.delete_table(u'osmosis_importsharderror')

        # Deleting field 'ImportShard.error_csv_written'
        db.delete_column(u'osmosis_importshard', 'error_csv_written')
